<div class="sub-header estate-planning mb-5">
...
<div class="container mb-5">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-12 col-md-12 col-lg-6 text-center">
            <img class="img-fluid" alt="a mom and daughter hugging an smiling" src="https://res.cloudinary.com/empuls3/image/upload/v1564088878/Hebert%20Thomas/ep-img-5.jpg" width="">
        </div>
    </div>
</div>
...
<div class="container-fluid p-0 m-0 mb-5">
    <div class="row m-0">
        <div class="col-sm-12 col-md-12 col-lg-6 d-flex justify-content-center full-dark p-5">
        ...
        <div class="col-sm-12 col-md-12 col-lg-6 estate-planning-3"></div>
    </div>
</div>
...
<div class="container mb-5">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-6">
            <img class="img-fluid mb-3" alt="a mother hugging her baby" src="https://res.cloudinary.com/empuls3/image/upload/v1564088004/Hebert%20Thomas/ep-img-3.jpg" width="">
            <h3>Guardian of the Person</h3>
            <p>
        ...
        <div class="col-sm-12 col-md-12 col-lg-6">
            <img class="img-fluid mb-3" alt="a black man shaking hands and smiling" src="https://res.cloudinary.com/empuls3/image/upload/v1564088005/Hebert%20Thomas/ep-img-4.jpg" width="">
            <h3>Guardian of the Estate</h3>
            <p>
